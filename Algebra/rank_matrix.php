...
echo "<form method='GET' action='rank_matrix2.php'>";
...
echo "<br>";
echo "<h1>Вычисление ранга матрицы</h1>";
echo "<h2>Введите элементы матрицы 3×3:</h2>";
...
echo "<td>Ранг = <input type='text' name='user_rank' size='3' value='0' required></td>";

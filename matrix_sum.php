...
echo "<tr>";
echo "<td> <input type='text' name='b31' size='3' value='0' required>  x1 +</td>";
echo "<td> <input type='text' name='b32' size='3' value='0' required>  x2 +</td>";
echo "<td> <input type='text' name='b33' size='3' value='0' required>  x3 =</td>";
echo "</tr>";
...
echo "<tr>";
echo "<td> <input type='text' name='c31' size='3' value='0' required>  x1 +</td>";
echo "<td> <input type='text' name='c32' size='3' value='0' required>  x2 +</td>";
echo "<td> <input type='text' name='c33' size='3' value='0' required>  x3 =</td>";
echo "</tr>";
